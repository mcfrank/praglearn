...
\title{Learning to communicate using recursive pragmatic
...
This kind of pragmatic reasoning is core to language use, 
...
scalar implicature as a matrix $\left[
  ...
  \textit{all}, giving speaker probabilities of
  $\left[
    \begin{array}{cc}
      1.00 & 0.00 \\
      0.00 & 1.00
...
% distributions than bad worlds, and thus more consistent behavior by
...
themselves are not, then we are able to preserve most of the normative
Bayesian framework, explicitly model both learning and recursive
social reasoning simultaneously within the same framework, and avoid
paradox. The resulting theory unifies two previously separate
strands of modelling work on language usage and acquisition,
accounting for a superset of previous phenomena, while producing a
variety of new qualitative patterns. In particular, we make new 
