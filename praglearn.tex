...
\midrule
Interpreting scalar implicature & \cite{grice1975} &  & x &x & x\\
...
The recursive pragmatic reasoning portions of our model capture set of findings on scalar implicature effectively. Consider a lexicon
$\left[
    \begin{array}{cc}
      0.5 & 0.5 \\
      0 & 1
