...
% Clearly we must deviate from pure normativity -- but how? Here, we propose to resolve the above problems with a model of speakers and listeners as rational agents afflicted by a kind of social anxiety. 
